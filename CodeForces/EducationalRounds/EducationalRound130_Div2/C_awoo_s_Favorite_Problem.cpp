...
void solve() {
    ...
    // 'a' in x can send a 'b' backwads
    // 'c' in x can send a 'b' forward

    For(n) {
        if (req == 0) {
            // Everything before has been handled

            if (x[i] == y[i]) continue;
            else if (x[i] == 'a' and y[i] == 'b') { 
                // Enter the 'a' cycle
                req = 1;
            } else if (x[i] == 'b' and y[i] == 'c') {
                // Enter the 'c' cycle
                req = -1;
            } else {
            ...
            // x is requesting 'req' bs from in front 
            // In 'a' cycle
            ...
            // x has 'req' extra bs which can be sent to back
            // Entering 'c' cycle 
