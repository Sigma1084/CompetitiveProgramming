...
using T = array<int, 2>;  // (XOR of zeros, XOR of ones)
using U = signed char;  // 1 to reverse 0 to keep quiet
struct SegTree: LazySegTreeBase<T, U> {
    constexpr static T idElement = {0, 0};  // xor
    constexpr static U idUpdate = 0;  // xor
